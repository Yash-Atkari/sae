...
export const AuthProvider = ({ children }) => {
  ...
  const signIn = async (email, password) => {
    try {
      ...
      return { error: { message: 'Cannot connect to authentication service. Your Supabase project may be paused or inactive. Please check your Supabase dashboard and resume your project if needed.' } }
    }
  }
